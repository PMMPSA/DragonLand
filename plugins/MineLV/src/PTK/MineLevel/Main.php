    ...
    public function onBreak(BlockBreakEvent $ev){
        ...
        if($block->getId() === Block::DIAMOND_BLOCK or $block->getId() === Block::EMERALD_BLOCK or $block->getId() === Block::REDSTONE_BLOCK or $block->getId() === Block::GOLD_BLOCK or $block->getId() === Block::IRON_BLOCK or $block->getId() === Block::LAPIS_BLOCK){
            ...
            if($this->getCurrentExp($p) >= $this->getLevelUpExp($p)){
                ...
                $p->sendMessage("§b======§eLEVEL§b======");
                $this->getServer()->broadcastMessage("§b[§cD§aR§6L§b-§9LEVEL§b]§a Người chơi §b" . $name . "§a Đã Lên Cấp§b ".$this->getCurrentLevel($p));
                $p->getInventory()->addItem(Item::get(57,0,10));
                $p->sendMessage("§b[§cD§aR§6L§b-§9LEVEL§b]§e•»§a Bạn Đã Nhận Được 10 Khối Kim Cương!!");
            }
        }
        ...
        switch($command->getName()){
            case "ilevel":
                ...
                if (isset($args[0])){
                    ...
                    $s->sendMessage("§b[§cD§aR§6L§b-§9LEVEL§b]§e•»§c Người Chơi Không Tồn Tại!");
                }}
                return true;
            case "setilevel":
                if (count($args) < 0) {
                    $s->sendMessage("§b[§cD§aR§6L§b-§9LEVEL§b]§e•»§6 Xin Hãy Sử Dụng Lệnh: /setilevel (Tên Người Chơi) [Số Cấp Độ]");
                    
                }
                if (!is_numeric($args[0])) {
                    $s->sendMessage("§b[§cD§aR§6L§b-§9LEVEL§b]§e•»§6 Số Cấp Độ Phải Là Số!");
                }
                if (isset($args[1])) {
